...
create_clock -add -name sys_clk_pin -period 10 -waveform {0 5} [get_ports { clk }]; #100Mhz
...
#Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { ssi_clk }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { data }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { zero }]; #IO_L1P_T0_34 Sch=jc_p[2]              
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { cs }]; #IO_L19P_T3_35 Sch=je[4]                     
